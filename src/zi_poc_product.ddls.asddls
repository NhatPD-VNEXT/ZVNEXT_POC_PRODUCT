...
define root view entity ZI_POC_PRODUCT
  ...
  association [0..1] to ZI_ChemicalComplianceVH as _ChemicalComplianceVH on $projection.IsChemicalComplianceRelevant = _ChemicalComplianceVH.IsChemicalComplianceRelevant

{
  key product                                               as Product,
      ...
      cast( productisconfigurable     as abap_boolean )     as ProductIsConfigurable,
      cast( isbatchmanagementrequired as abap_boolean )     as IsBatchManagementRequired,
      ...
      cast( isrelevantforhzds        as abap_boolean )      as IsRelevantForHzds,
      ...
      cast( hasvariabletareweight    as abap_boolean )      as HasVariableTareWeight,
      ...
      _ChemicalComplianceVH.DomainValueText                 as ComplianceRelevantText,
      ...
      cast( productislocked          as abap_boolean )      as ProductIsLocked,
      ...
      case
          when is_approval is not initial
              then 'Approved'
          else 'Not Approved'
