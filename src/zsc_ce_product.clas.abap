...
"! <em>com.sap.gateway.srvd_a2x.api_product_3.v0001</em>
CLASS zsc_ce_product DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Value Control Structure of PRODUCT_VALUATION_LEDGER_2</p>
...
CLASS ZSC_CE_PRODUCT IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'com.sap.gateway.srvd_a2x.api_product_3.v0001' ) ##NO_TEXT.
